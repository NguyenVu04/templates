...
- **Authorization ≠ authentication**: every endpoint that fetches a resource by ID must check the current user may access THAT resource (IDOR). This check lives in the service.
